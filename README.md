...
- [Koyeb](https://www.koyeb.com) `alive` — high-performance infrastructure for APIs, inference, and databases across CPUs, GPUs, and accelerators.
...
- [Scalingo](https://scalingo.com) `alive` — French PaaS, European Heroku alternative.
...
- [Gatsby Cloud](https://www.gatsbyjs.com/products/cloud/) `defunct` — sunset; the page now serves Netlify's acquisition announcement.
...
- [Digger](https://digger.dev/) `alive` — self-hostable Terraform CI/CD, drift detection, PR automation, and state management.
- [Disco](https://disco.cloud/) `alive` — self-hosted Heroku alternative for teams with many services and environments.
...
- [Kubeless](https://kubeless.io/) `defunct` — site offline; project was archived.
- [Kubernetes](https://kubernetes.io/) `alive` — production-grade container orchestration.
- [Kubero](https://github.com/kubero-dev/kubero) `alive` — free, self-hosted PaaS alternative running on Kubernetes.
...
- [Porter](https://porter.run) `alive` — deploys apps effortlessly to your own AWS, GCP, or Azure account; SOC 2 & HIPAA compliant with autoscaling.
- [Qovery](https://www.qovery.com/) `alive` — Kubernetes management platform (also listed under PaaS).
- [Setops](https://www.setops.co/) `defunct` — site offline.
- [Skaffold](https://skaffold.dev/) `alive` — fast, repeatable, simple workflow for Kubernetes development.
...
- [Werf](https://werf.io) `alive` — GitOps tool by Flant for delivering apps to Kubernetes.
- [ZaneOps](https://zaneops.dev) `alive` — self-hosted, open source PaaS using Docker Swarm.
- [Zeabur](https://zeabur.com) `alive` — AI DevOps engineer (also listed under PaaS).
...
- [Release](https://release.com/) `alive` — Vercel-style git-push deploys for full-stack apps.
- [Replit](https://replit.com/) `alive` — build and deploy apps and sites collaboratively with AI.
